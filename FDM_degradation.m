...
D(1) = double(subs(diff(J_s,c_s_n),[c_s_n,I],[n.c_max_n*0.5,u]));

D(2) = double(subs(diff(J_s,I),[c_s_n,I],[n.c_max_n*0.5,u]));

D(3) = double(subs(J_s,[c_s_n,I],[n.c_max_n*0.5,u]));
